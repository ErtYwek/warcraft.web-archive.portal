            ...
            pre: [
                {
                    ...
                    name: 'login',
                    innerHTML: 'Login',
                    href: 'https://secure.fanbyte.com/login.html?action=login'
                },
                {
                    type: 'link',
                    name: 'register',
                    innerHTML: 'Create Account',
                    href: 'https://secure.fanbyte.com/login.html?action=new'
                },
                {
                    type: 'link',
                    name: 'premium',
                    innerHTML: 'Premium Services',
                    href: 'http://legacy.fanbyte.com/subscribe.html'
                }
            ]
        },
        loggedIn: {
...
/**
 * Put zul bar in container
 */
function zulBarIntoContainer() {
  if (!document.body || !document.querySelector('#zul-bar')) {
    setTimeout(zulBarIntoContainer, 5);
    return;
  }
  const zulBar = document.querySelector('#zul-bar');
  const container = document.querySelector('#zul-bar-container');
  container.appendChild(zulBar);
}
zulBarIntoContainer();